...
## load object
```{r load merged object all, eval=FALSE}
...
## subset adult
```{r subset adult datasets, eval=FALSE}
...
## plot umaps
### clustering
```{r umap clustering pre filter, eval=FALSE}
...
### location
```{r umap location pre filter, eval=FALSE}
...
```{r cluster marker genes pre filter, eval=FALSE}
