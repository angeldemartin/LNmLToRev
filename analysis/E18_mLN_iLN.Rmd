...
### counts
```{r counts}
seuratE18fil.intSub <- subset(seuratE18fil.int, Rosa26eyfp.Rosa26eyfp>0)
eyfpPos <- colnames(seuratE18fil.intSub)
seuratE18fil.int$EYFP <- "neg"
seuratE18fil.int$EYFP[which(colnames(seuratE18fil.int)%in%eyfpPos)] <- "pos"
